...
Напишите программу, которая запрашивает возраст пользователя и выводит соответствующую категорию:
○ Младенец: до 2 лет включительно.
○ Ребёнок: от 3 до 12 лет включительно.
○ Подросток: от 13 до 17 лет включительно.
